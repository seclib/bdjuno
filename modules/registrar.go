...
import (
	...
	"github.com/forbole/bdjuno/v4/modules/btclightclient"
...
func (r *Registrar) BuildModules(ctx registrar.Context) jmodules.Modules {
	...
	btclightclientModule := btclightclient.NewModule(sources.BtcLightClientSource, cdc, db)
